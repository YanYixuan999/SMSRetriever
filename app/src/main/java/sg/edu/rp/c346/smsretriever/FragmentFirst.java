...
public class FragmentFirst extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnNumberRetrieve = view.findViewById(R.id.btnNumber);
        tvNumberSMS = view.findViewById(R.id.tvNumberSMS);



        btnNumberRetrieve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(permissionCheck != PermissionChecker.PERMISSION_GRANTED){
                    ActivityCompat.requestPermissions
                            (getActivity(), new String[]{Manifest.permission.READ_SMS},0);
        ...
        switch (requestCode) {
            case 0: {
                ...
                if (grantResults.length > 0
                    ...
                    btnNumberRetrieve.performClick();
